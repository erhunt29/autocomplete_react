...
function (_Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    value: function openList() {
      ...
      var classNameShort = dataAll.length > 4 ? 'autocomplete__list_short' : '';
      var classNameVisually = !isOpen ? 'hidden ' : '';
      var elements = dataAll.map(function (el) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: 'autocomplete__list__li',
          onClick: function onClick(evt) {
            return _this3.inputValue(evt);
          },
          key: el
        }, el[0], react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", {
          key: el[1]
        }, el[1]), el[2]);
      });
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: 'autocomplete__list' + ' ' + classNameShort + ' ' + classNameVisually
      }, elements);
    }
  }, {
    key: "inputValue",
    value: function inputValue(evt) {
      var value = evt.target.innerHTML;
      var boldIndexStart = value.indexOf('<b>');
      var boldIndexEnd = value.indexOf('</b>');

      if (boldIndexStart !== -1) {
        value = value.slice(0, boldIndexStart) + value.slice(boldIndexStart + 3, boldIndexEnd) + value.slice(boldIndexEnd + 4, value.length);
      }
    ...
    value: function filterList(evt) {
      ...
      var arrFiltred = data.filter(function (el) {
        return el.toLowerCase().indexOf(value.toLowerCase()) !== -1;
      });
      var arrBoldValue = arrFiltred.map(function (el) {
        var index = el.toLowerCase().indexOf(value.toLowerCase());
        var endIndex = index + value.length;
        var lastIndex = el.length;
        var startString = el.slice(0, index);
        var boldString = el.slice(index, endIndex);
        var lastString = el.slice(endIndex, lastIndex);
...
var carsString = 'Toyota,Ford,Chevrolet,Nissan,Hyundai,KIA,Mercedes-Benz,BMW,Opel,Mazda,Acura,Volkswagen,Citroen,Volvo,Skoda,Land Rover,Renault,Honda,Datsun,Mitsubishi,Audi,Jeep,LADA,УАЗ,Peugeot,Daewoo,SsangYong,Lexus,Subaru,Suzuki,Infiniti,Fiat,Chery,Lifan,Brilliance,Geely,Great Wall';
var data = carsString.split(',').sort();
...
var placeholder = 'Select your car';
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Autocomplete__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
module.exports = __webpack_require__(/*! /Users/artemtitov/Desktop/Frontend developer/my projects/React js practice/Autocomplete/src/index.js */"./src/index.js");
